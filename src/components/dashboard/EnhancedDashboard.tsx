            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="animate-fade-in" style={{ animationDelay: "150ms" }}>
                <MetricCard
                  ...
                  value={formatCurrency(applyVat(metrics.monthlyIncome))}
                  icon={<Euro />}
                  colorScheme="revenue"
                  change={{
              ...
              <div className="animate-fade-in" style={{ animationDelay: "200ms" }}>
                <MetricCard
                  ...
                  value={formatCurrency(applyVat(metrics.monthlyExpenses))}
                  icon={<TrendingUp />}
                  colorScheme="expense"
                  change={{
              ...
              <div className="animate-fade-in" style={{ animationDelay: "250ms" }}>
                <MetricCard
                  ...
                  value={formatCurrency(applyVat(metrics.netCashflow))}
                  icon={<Briefcase />}
              ...
              <div className="animate-fade-in" style={{ animationDelay: "300ms" }}>
                <MetricCard
                  ...
                  value={formatCurrency(applyVat(metrics.pendingValue))}
                  icon={<Clock />}
                  colorScheme="pending"
                  change={{
